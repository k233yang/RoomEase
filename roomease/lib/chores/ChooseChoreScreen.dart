                ...
                if (mounted) {
                  final result =
                    ...
                    builder: (context) => EditChoreScreen(
                      ...
                      onChoreUpdate: (String newChoreId, Chore oldChore) async {
                        ...
                        Chore? newChore = await DatabaseManager.getChoreFromId(
                            newChoreId,
                        ...
                        Map<String, String> oldChoreParameters = {
                          ...
                          "ChorePointsThreshold": oldChore.threshold.toString(),
                        };
                        Map<String, String> newChoreParameters = {
                          ...
                          "ChorePointsThreshold": newChore.threshold.toString(),
                        };
                        String updateChoreMessage = generateUpdateCommandInput(
